import sys
from PyQt5.QtWidgets import QApplication, QWidget, QPushButton, QMessageBox, QLineEdit, QHBoxLayout, QVBoxLayout, QTableWidgetItem, QTableWidget, QGridLayout, QProgressBar, QLabel, QSpinBox, QHeaderView, QSizePolicy, QTextBrowser
...
class Exam(QWidget):
    ...
    def defineItem(self):
        self.btn_regist = QPushButton('spr_regist')
        self.btn_search = QPushButton('spr_search')
        ...
        self.btn_spr_info_load = QPushButton('spr_info_load')
        self.btn_spr_file_job_0_load = QPushButton('spr_file_job_0_load')
        self.btn_spr_file_job_1_load = QPushButton('spr_file_job_1_load')
        self.btn_spr_tar_convert = QPushButton('spr_tar_convert')
        self.ed_conv_spr_no = QLineEdit('DI.KyLee.')
        self.btn_spr_all_convert = QPushButton('spr_all_convert')
        
        self.btn_spr_sum_load = QPushButton('spr_sum_load')
        self.btn_spr_tar_load = QPushButton('spr_tar_load')
        self.btn_spr_tar_save = QPushButton('spr_tar_save')
        self.ed_spr_tar_no = QLineEdit('DI.KyLee.')
        self.btn_spr_all_load = QPushButton('spr_all_load')
        self.btn_spr_all_save = QPushButton('spr_all_save')
        ...
        self.hbox1.addWidget(self.btn_init)
        self.hbox1.addWidget(self.btn_save_server)
        self.hbox1.addWidget(self.btn_load_server)
    ...
    def initUI(self):
        ...
        self.setGeometry(0,0,1024,1366)
        self.show()
